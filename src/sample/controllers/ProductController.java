    ...
    void deleteProduct(ActionEvent actionEvent) throws SQLException {
        if (idProduct.getText().equals("")) {
            ...
            try {
                ...
                if (!CollectionDAO.dbCheckIfExistCollection(Integer.parseInt(idProduct.getText()))) {
                    JOptionPane.showMessageDialog(null, "There no such collection with id: " + idProduct.getText());
                    return;
                }
